                  ...
                  <div className='h-[1400px] flex flex-col justify-around px-10'>
                    ...
                    <p className='opacity-80 text-xl'>{row.info}</p>
                    {
                      row.descrip === undefined ?
                        ...
                        :
                        <ul>
                          {row.descrip.map((list, index) => (
                            <li className={`text-xl  opacity-80 ${index === 0 ? "opacity-100 font-bold pb-3 text-2xl" : null}`}>
                              {list + (index === 0 ?  ":" : "")}
                            </li>
                          ))}
                        </ul>
                    ...
                    <p className='font-semibold text-2xl'>$ {row.price} COP.</p>
                    <div className='flex justify-center'><Button children="Contáctame" handler={() => handler()} /></div>
                  </div>
                </div>
